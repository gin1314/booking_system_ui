...
import { postCreateUser as postCreateUserApi } from 'src/api';
  ...
  function CreateUserSuccessDialog({ open, handleClose, message }) {
    return (
      <Dialog
        ...
        fullWidth
      >
        <DialogTitle id="user-dialog-title">{'User Created Success'}</DialogTitle>
        <DialogContent>
            ...
            <Formik
              ...
              onSubmit={async (
                ...
                try {
                  ...
                  const response = await postCreateUserApi(values);
...
Booking.Layout = DashboardLayout;
